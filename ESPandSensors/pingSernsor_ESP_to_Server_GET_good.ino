...
void setup() {
  ...
  if (!client.connect(host, port)) {
    ...
    HTTPClient http;
    int val=80;
    //String postData = String("http://fathomless-citadel-40087.herokuapp.com/test") + String("?data="  ) + String(val);
    String postData = String("http://fathomless-citadel-40087.herokuapp.com/get") + String("?data="  ) + String(val);
